...
const projects = ref<Project[]>([
  {
    ...
    leader: 'Eileen',
    team: [{ avatar: mujer }, { avatar: mujer }, { avatar: mujer }, { avatar: hombre }],
    progress: 78,
    icon: react
  },
  {
    ...
    leader: 'Owen',
    team: [{ avatar: mujer }, { avatar: mujer }],
    progress: 25,
    icon: support
  },
  {
    ...
    leader: 'Keith',
    team: [{ avatar: hombre }, { avatar: mujer }, { avatar: mujer }, { avatar: mujer }],
    progress: 62,
    icon: ui
  },
  {
