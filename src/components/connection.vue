  ...
  <div class="section">
    ...
    <div class="connections-list">
      <div class="connection-item" v-for="(contact, index) in connections" :key="index">
        ...
        <button
          :class="['connection-button', { connected: contact.connected }]"
          @click="toggleConnection(contact)"
        >
...
const connections = ref<Contact[]>([
  ...
  { name: 'Luis saldarriaga', connections: 1.32, img: hombre, connected: true },
  { name: 'Iris Piñeres', connections: 125, img: mujer, connected: false },
  { name: 'Camilo alzate', connections: 456, img: hombre, connected: false },
  { name: 'Camila arias', connections: 1.2, img: hombre, connected: false }
])
