      ...
      <div class="card-details">
        ...
        <div class="hours-time-container">
          ...
          <div class="time-left-info">
            <div
              :style="{ backgroundColor: card.timeLeftBackground, color: card.timeLeftTextColor }"
              class="time-left"
            >
              {{ card.timeLeft }}
            </div>
...
import twiter from '../../src/assets/images/twiter.jpg'
import hombre from '../../src/assets/images/hombre.png'
