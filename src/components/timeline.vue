<template>
  <div class="timeline-container">
    <h3 class="timeline-header"><i class="fa-solid fa-chart-simple"></i> Activity Timeline</h3>
    <div class="timeline">
      <div v-for="(item, index) in timelineItems" :key="index" class="timeline-item">
        <div
          :class="['timeline-dot', item.color]"
          class="{ 'with-line': index < timelineItems.length}"
        ></div>
